...
static volatile unsigned char UART1_TxBuf[1];
static volatile unsigned char UART1_RxBuf[1];
...
static volatile unsigned char UART2_TxBuf[1];
static volatile unsigned char UART2_RxBuf[1];
...
/************************************************************************
Function: uart0_bytesWaiting()
Purpose:  returns the number of bytes in the receive-buffer
Returns:  number of bytes in receive buffer
*************************************************************************/
uint8_t uart0_bytesWaiting(void) {
	return (UART_RxHead - UART_RxTail) & UART_RX_BUFFER_MASK;
} /* uart0_bytesWaiting */

/************************************************************************
Function: uart0_txWaiting()
Purpose:  returns the difference between end and start of ringbuffer
*************************************************************************/
uint8_t uart0_txWaiting(void){
	return (UART_TxHead - UART_TxTail) & UART_RX_BUFFER_MASK;
}
...
/************************************************************************
Function: uart1_bytesWaiting()
Purpose:  returns the number of bytes in the receive-buffer
Returns:  number of bytes in receive buffer
*************************************************************************/
uint8_t uart1_bytesWaiting(void) {
	return (UART1_RxHead - UART1_RxTail) & UART_RX_BUFFER_MASK;
} /* uart1_bytesWaiting */

/************************************************************************
Function: uart1_txWaiting()
Purpose:  returns the difference between end and start of ringbuffer
*************************************************************************/
uint8_t uart1_txWaiting(void){
	return (UART1_TxHead - UART1_TxTail) & UART_RX_BUFFER_MASK;
}
#endif
...
**************************************************************************/
{
    ...
    if ( UART2_TxHead != UART2_TxTail) {
        ...
        /* get one byte from buffer and write it to UART */
	UART2_STATUS |= _BV(UART2_TXC);
        UART2_DATA = UART2_TxBuf[tmptail];  /* start transmission */
    }else{
        /* tx buffer empty, disable UDRE interrupt */
        UART2_CONTROL &= ~_BV(UART1_UDRIE);
    }
}
...
/************************************************************************
Function: uart2_bytesWaiting()
Purpose:  returns the number of bytes in the receive-buffer
Returns:  number of bytes in receive buffer
*************************************************************************/
uint8_t uart2_bytesWaiting(void) {
	return (UART2_RxHead - UART2_RxTail) & UART_RX_BUFFER_MASK;
} /* uart2_bytesWaiting */

/************************************************************************
Function: uart2_txWaiting()
Purpose:  returns the difference between end and start of ringbuffer
*************************************************************************/
uint8_t uart2_txWaiting(void){
	return (UART2_TxHead - UART2_TxTail) & UART_RX_BUFFER_MASK;
}
...
/************************************************************************
Function: uart3_bytesWaiting()
Purpose:  returns the number of bytes in the receive-buffer
Returns:  number of bytes in receive buffer
*************************************************************************/
uint8_t uart3_bytesWaiting(void) {
	return (UART3_RxHead - UART3_RxTail) & UART_RX_BUFFER_MASK;
} /* uart0_bytesWaiting */


/************************************************************************
Function: uart3_txWaiting()
Purpose:  returns the difference between end and start of ringbuffer
*************************************************************************/
uint8_t uart3_txWaiting(void){
	return (UART3_TxHead - UART3_TxTail) & UART_RX_BUFFER_MASK;
}
